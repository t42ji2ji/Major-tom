module.exports = async (context, match) => {
  const musics = [
    ...
    ["而我知道", "https://www.youtube.com/watch?v=Gv3HOUMEPiw&t=208s", "一直都很喜歡這首歌，也是唯一讓我在演唱會上起雞皮疙瘩的一首，五月天已經不是歌手而是我們這代人的共同青春回憶。"],
    ["自己的歌", "https://www.youtube.com/watch?v=WMVtriQkPxg", "以前聽李宗盛是覺得好聽，現在聽李宗盛是感覺自己被理解。如果有一個歌手可以寫出女人的心思細膩，也可以活出男人孤獨的浪漫，那大概就只有李宗盛了。"],
    ["Santé - ?te 壞特", "https://www.youtube.com/watch?v=megYQRIb5qw", "被Youtube演算法推薦的歌曲，我向來不喜歡被機器推薦，因為顯得很沒有自己的品味，但是這首歌一聽就中了，原文Sante是來自法文乾杯的意思，其實本意是指\'健康\'，所以在法國不乾杯是不健康哦。"],
  ]
